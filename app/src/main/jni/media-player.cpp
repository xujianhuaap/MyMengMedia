...
Java_cn_skullmind_mbp_media_MediaPlayer_nativeInit
        (JNIEnv
         *env,
         jobject obj, jstring
         url) {
...
JNIEXPORT void JNICALL
Java_cn_skullmind_mbp_media_MediaPlayer_nativePlay
        (JNIEnv
         *env,
         jobject obj
        ) {
...
JNIEXPORT void JNICALL
Java_cn_skullmind_mbp_media_MediaPlayer_nativePause
        (JNIEnv
         *env,
         jobject obj
        ) {
...
JNIEXPORT void JNICALL
Java_cn_skullmind_mbp_media_MediaPlayer_nativeStop
        (JNIEnv
         *env,
         jobject obj
        ) {
...
JNIEXPORT void JNICALL
Java_cn_skullmind_mbp_media_MediaPlayer_nativeSeekToPos
        (JNIEnv
         *env,
         jobject obj, jint
         pos) {
...
JNIEXPORT void JNICALL
Java_cn_skullmind_mbp_media_MediaPlayer_nativeUnInit
        (JNIEnv
         *env,
         jobject obj
        ) {
